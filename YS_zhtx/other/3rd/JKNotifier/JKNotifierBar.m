...
//    self.timeLabel.text = @"刚刚";
    ...
    self.iconView.frame = CGRectMake(15, [[HTGetPhoneType iphoneType] isEqualToString:@"iPhone X"] ? 24 : 0 +  7, 20, 20);
//    [[HTGetPhoneType iphoneType] isEqualToString:@"iPhone X"] ? 24 : 0
    ...
    self.nameLabel.frame = CGRectMake(self.edge.left,[[HTGetPhoneType iphoneType] isEqualToString:@"iPhone X"] ? 24 : 0 + self.edge.top, CGRectGetWidth(self.frame)-self.edge.left-self.edge.right,nameLabelHeight);
