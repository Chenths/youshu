...
- (void)awakeFromNib
{
    ...
    self.lineDefaultColor = [UIColor colorWithHexString:@"#999999"];
...
- (void)showTheHistoryContentTableView:(CGFloat)y
{
    ...
    self.tableView.frame = CGRectMake(self.x, self.y + self.height, self.width, tableViewH);
