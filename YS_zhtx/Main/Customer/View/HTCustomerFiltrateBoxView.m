...
@interface HTCustomerFiltrateBoxView()<UITableViewDelegate,UITableViewDataSource,UICollectionViewDelegate,UICollectionViewDataSource>
...
@implementation HTCustomerFiltrateBoxView
...
-(void)awakeFromNib{
    [super awakeFromNib];
    [self conginBT:self.firstBt withTitle:@"创建时间" andImg:@"g-mineDown"];
    [self conginBT:self.secondBt withTitle:@"性别" andImg:@"g-mineDown"];
    [self conginBT:self.thirdBt withTitle:@"等级" andImg:@"g-mineDown"];
    [self conginBT:self.fourthBt withTitle:@"查找" andImg:@"customer_search"];
}
...
{
    HTCustomerFiltrateBoxView *boxView = [[NSBundle mainBundle] loadNibNamed:@"HTCustomerFiltrateBoxView" owner:nil options:nil].lastObject;
